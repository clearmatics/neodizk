 ...
 */
public class R1CSRelationRDD<FieldT extends AbstractFieldElementExpanded<FieldT>>
  ...
  public boolean isSatisfied(
    ...
    final JavaPairRDD<Long, FieldT> A =
        constraints()
            .A()
            .filter(e -> e._2.index() != 0)
            .mapToPair(
    ...
    final JavaPairRDD<Long, FieldT> B =
        constraints()
            .B()
            .filter(e -> e._2.index() != 0)
            .mapToPair(
    ...
    final JavaPairRDD<Long, FieldT> C =
        constraints()
            .C()
            .filter(e -> e._2.index() != 0)
            .mapToPair(
