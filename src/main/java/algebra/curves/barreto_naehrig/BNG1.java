...
/**
 * Generic code to construct and operate on BN G1 points. This class is used to represent a BN G1
 * group as well as their points (both are mixed here): - BNG1(): Is used to construct the group -
 * BNG1.construct(): Is used to construct the points (of type BNG1T) => construct() wraps the group
 * constructor - Other functions of this class like: add() operate on `BNG1T` (the points)
 */
